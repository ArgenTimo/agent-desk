...
def kind_prompt(text: str, *, pointed_at: int = 0) -> str:
    ...
    return "\n".join(
        [
            ...
            "  draw     — they want something drawn as cards on the workbench: either they are",
            "             describing a *process* — steps with decisions in it — or they want",
            "             a *map* of what a project actually has: its parts, what each of them is,",
            "             and how they relate. Not a question about a process, not a wish that",
            "             one existed, and not an answer in prose.",
            '             "нарисуй процесс релиза: сначала тесты, если красные — чиним", "draw me',
            '             the onboarding flow", "изобрази как это работает по шагам", "нарисуй',
            '             как устроен этот проект", "разложи модули и что от чего зависит",',
            '             "map the services and what talks to what"',
